...
export default {
  ...
  dag: {
    ...
    workbench: 'DAG Workbench',
    component_library: 'Component Center',
    task_library: 'Task Components',
    search_component: 'Search components',
    search_node: 'Locate a workflow node',
    node_count: '{count} nodes',
    edge_count: '{count} edges',
    favorite: 'Favorite component',
    empty_workflow: 'No task nodes',
    edit_mode: 'Edit mode',
