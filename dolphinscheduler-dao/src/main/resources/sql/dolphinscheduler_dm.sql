...
-- ETL metadata schema for native Dameng DM8 (COMPATIBLE_MODE=0).
...
ALTER TABLE t_ds_version MODIFY id DEFAULT t_ds_version_id_sequence.NEXTVAL;
...
-- Records of t_ds_queue,default queue name : default
INSERT INTO t_ds_version(version) VALUES ('3.5.0');
